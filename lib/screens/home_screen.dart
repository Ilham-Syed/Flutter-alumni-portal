  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: false,
        title: const Text("Welcome",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                       ...
                       children: <Widget>[
                         Container(
                           ...
                           decoration: BoxDecoration(
                             ...
                             image: DecorationImage(
                               fit: BoxFit.fill,
                               image:AssetImage("assets/images/campusvesit.jpg"),
                             ),
                         ...
                         Container(
                           ...
                           child: Center(
                             child:AnimatedTextKit(
                                 animatedTexts:[
                                   RotateAnimatedText("Events",textStyle: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: hexStringToColor("#36a3b0"))),
                                   RotateAnimatedText("Job Opportunities",textStyle: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: hexStringToColor("#36a3b0"))),
                                   RotateAnimatedText("Alumni register",textStyle: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: hexStringToColor("#36a3b0"))) ,
                                   RotateAnimatedText("Blogs",textStyle: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: hexStringToColor("#36a3b0"))),
                                   RotateAnimatedText("Gallery",textStyle: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: hexStringToColor("#36a3b0"))),
                                 ]
                             ),
                           ),
                         ),
